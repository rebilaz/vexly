...
export const toolPage = defineType({
  ...
  groups: [
    ...
    { name: "calculator", title: "Calculateur" },
    { name: "sections", title: "Sections SEO" },
    { name: "seo", title: "SEO" },
  ],
  fields: [
    defineField({
    ...
    defineField({
      ...
      fields: [
        defineField({
          ...
          description:
            "Cette valeur doit exister dans composants/outils/outil-registry.ts.",
          type: "string",
          options: {
            list: [
              { title: "MRR YouTube", value: "mrr-youtube" },
              { title: "Coût d’un MVP", value: "mvp-cost" },
              { title: "Validateur d’idée", value: "idea-validator" },
              { title: "Seuil de rentabilité", value: "break-even" },
            ],
            layout: "dropdown",
          },
          validation: (Rule) => Rule.required(),
        ...
        defineField({
          ...
          type: "number",
          hidden: ({ parent }) => parent?.toolType !== "mrr-youtube",
          validation: (Rule) => Rule.min(0),
        }),
        defineField({
          name: "conversionRate",
          title: "Taux de conversion en pourcentage",
          description: "Exemple : écrire 0.2 pour 0,20 %.",
          type: "number",
          hidden: ({ parent }) => parent?.toolType !== "mrr-youtube",
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: "formula", title: "Formule affichée", type: "string" }),
        defineField({
          name: "steps",
          title: "Étapes",
          type: "array",
          ...
          of: [
            {
              ...
              name: "relatedItem",
              fields: [
                defineField({ name: "label", title: "Badge", type: "string" }),
                defineField({
                  name: "title",
                  title: "Titre",
                  type: "string",
                ...
                defineField({
                  ...
                  description: "Exemple : /articles/mon-article",
                  type: "string",
                  validation: (Rule) => Rule.required(),
                }),
                defineField({ name: "description", title: "Description", type: "text", rows: 3 }),
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: "secondaryLabel", title: "Texte du bouton secondaire", type: "string" }),
        defineField({ name: "secondaryHref", title: "Lien du bouton secondaire", type: "string" }),
      ],
    }),
    defineField({
      name: "seo",
  ...
  preview: {
    ...
    prepare({ title, subtitle }) {
      return {
        title,
        subtitle: subtitle ? `/outils/${subtitle}` : "Slug manquant",
      };
    },
  },
});
