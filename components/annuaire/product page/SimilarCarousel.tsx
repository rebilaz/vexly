...
import type { Listing } from "@/lib/annuaire";
import { Image as SaaSImage } from "../saas page/Images";
 ...
 *
 * Convention :
 * - public/annuaire/previews/{slug}.jpg
 * - public/placeholders/saas.jpg
 */
function getSafeImage(p: Listing) {
    if (p?.slug) return `/annuaire/previews/${p.slug}.jpg`;
